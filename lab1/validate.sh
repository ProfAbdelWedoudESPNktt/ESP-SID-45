...
[ -d "data/lab2/raw" ]; check "data/lab2/raw/ exists"
[ -d "data/lab2/checkpoints" ]; check "data/lab2/checkpoints/ exists"
[ -d "data/lab2/output" ]; check "data/lab2/output/ exists"
...
if [ $ERRORS -eq 0 ] && [ $WARNINGS -eq 0 ]; then
    ...
    echo ""
    echo "Your environment is ready for Lab1 and Lab2."
    echo ""
    echo "Access points:"
